...
Based on S2D template with unmanaged storage built by: [robotechredmond](https://github.com/robotechredmond)
and on S2D template with managed storage built by: [chagarw] (https://github.com/chagarw)
