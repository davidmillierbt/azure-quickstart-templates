...
configuration ConfigS2D
{
    ...
    (
        ...
        [Parameter(Mandatory)]
        [System.Management.Automation.PSCredential]$daCreds,
    ...
    [System.Management.Automation.PSCredential]$DomainCreds = New-Object System.Management.Automation.PSCredential ("${DomainNetbiosName}\$($daCreds.UserName)", $daCreds.Password)
    [System.Management.Automation.PSCredential]$DomainFQDNCreds = New-Object System.Management.Automation.PSCredential ("${DomainName}\$($daCreds.UserName)", $daCreds.Password)
    ...
    Node localhost
    {
        ...
        Script CreateShare
        {
            SetScript = "New-Item -Path C:\ClusterStorage\Volume1\${ShareName} -ItemType Directory; New-SmbShare -Name ${ShareName} -Path C:\ClusterStorage\Volume1\${ShareName} -FullAccess ${DomainName}\$($daCreds.Username)"
